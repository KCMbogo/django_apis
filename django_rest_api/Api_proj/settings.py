...
SECRET_KEY = 'django-insecure-1g)78n_fc(8+pbzijue-dsp%ygba!yooa=0jt2f5&%y)+n@j=b'
...
# DATABASES = {'default': dj_database_url.parse('mysql://root@localhost/dj_api')}
DATABASES = {
    'default': {
...
# Specifying the user model to be used
